...
const BirthDetailsForm = () => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post("http://localhost:9003/api/getBirthChart", {
        dateString: userBirthDate ? userBirthDate : defaultdate,
        timeString: userBirthTime ? userBirthTime : defaulttime,
        lat: latitude ? latitude : defaultlatitude,
        lng: longitude ? longitude : defaultlongitude,
        timezone: "5",
        ayanamsha: 1,
      })
      .then((res) => {
  ...
  let time =
    locationVal?.current?.value !== "" ? locationVal?.current?.value?.split(",")[2] : "India";
  ...
  let defaultbirthplace = a3 !== undefined ? a3?.birthPlace : "";
  ...
  return (
    <div>
      <div>
        <Grid container spacing={1} sx={{ display: { xs: "none", md: "none" } }}>
        ...
        <Grid container spacing={2}>
          <Grid item lg={2} sm={6} md={4} xs={12}>
          ...
          <Grid item lg={1.5} sm={6} md={4} xs={12}>
            <InputLabel htmlFor="name" style={{ color: "black" }}>
              Birth time
            </InputLabel>
            <input
          ...
          <Grid item lg={1.5} sm={6} md={4} xs={12}>
            ...
            >
              <MenuItem value="North Indian">North</MenuItem>
              <MenuItem value="South Indian">South</MenuItem>
            </Select>
          </Grid>
          <Grid item lg={2} sm={6} md={4} xs={12} container spacing={2}>
            ...
            <div style={{ display: "flex", marginTop: "30px" }}>
              <Grid item>
                ...
                <TextField
                  ...
                  onChange={(e) => setLatidude(e.target.value)}
                  inputRef={latitudeVal}
                  value={defaultlatitude ? defaultlatitude : latitude}
                />
              </Grid>
              ...
              <Grid item style={{ marginLeft: "35px" }}>
                ...
                <TextField
                  ...
                  onChange={(e) => setlongitude(e.target.value)}
                  inputRef={longitudeVal}
                  value={defaultlongitude ? defaultlongitude : longitude}
                />
              </Grid>
              {console.log(timezone)}
              <Grid item style={{ marginLeft: "35px" }}>
                ...
                <TextField
                  ...
                  name="timeZone"
                  onChange={(e) => setTimeZone(e.target.value)}
                  value={defaulttimezone ? defaulttimezone : timezone}
                />
              </Grid>
            </div>
          ) : null}
