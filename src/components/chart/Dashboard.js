...
const Dashboard = () => {
  ...
  const [firstchartsShow, setFirstChartsShow] = useState("d1Chart");
  ...
  // console.log(finalTransitDate);

  useEffect(() => {
    axios
      .post("https://rahasyavedic.herokuapp.com/api/getprogressionChart", {
        dateString: `${moment(finalTransitDate).format("YYYY")}-04-24`,
        timeString: "13:17:17",
        lat: 54.567,
        lng: 64.657,
        ayanamsha: 1,
  ...
  const handleDate = (e) => {
    console.log(`moment(finalTransitDate).format("YYYY")-04-24`);
    axios
      .post("http://localhost:9003/api/getprogressionChart", {
        dateString: `${moment(finalTransitDate).format("YYYY")}-04-24`,
        timeString: "13:17:17",
        lat: 54.567,
        lng: 64.657,
  ...
  // console.log(moment(finalTransitDate).format("YYYY"));
  ...
  const handleFirstCharts = (e, val) => {
    setFirstChartsShow(e.target.lastChild.data);
    // console.log(e.target.lastChild.data);
  };
  ...
  return (
    <Fragment>
      <DragDropContext>
        ...
        <Grid className="chart-main" container spacing={3}>
          <Grid item xs={12} md={4}>
              ...
              <>
                <div className="chart-top-fields">
                  <Autocomplete
                    id="combo-box-demo"
                    options={top100Films}
                    onChange={(e) => handleFirstCharts(e)}
                  ...
                  />
                  <Toggle id="cheese-status" onClick={(e) => handleToggle(e)} />
                </div>
            ...
            <CardSummary style={{ backgroundColor: "white", border: "none" }}>
              <BirthChart color={color} toggleTrue={toggleTrue} firstchartsShow={firstchartsShow} />
            </CardSummary>
          </Grid>
          <Grid item xs={12} md={4}>
            <div>
              {data && (
                <>
                  ...
                  /> */}
                      ...
                      />
                      <datalist id="browsers" style={{ width: "50px", display: "none" }}>
                        {availableYears.map((item, index) => {
                          return <option>{item}</option>;
                        })}
                      </datalist>
