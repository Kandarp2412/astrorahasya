    ...
    <>
      {detailArray.map(([key, obj], index) => {
        return (
          <text
            style={{ fill: "red" }}
            //   (obj.houseSymbol ? (isDark ? { fill: "red" } : { fill: "red" }) : {},
            //   obj.graha ? (isDark ? { fill: "white" } : { fill: "black" }) : {})
            // }
            key={obj.text}
            id="XMLID_77_"
    ...
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" aria-labelledby="123title">
        ...
        <g id="Background">
          ...
          >
            <stop offset={0} stopColor={"#cce0f4"} stopOpacity={0.3} />
            <stop offset={0.18} stopColor={"#d1dceb"} stopOpacity={0.282} />
            <stop offset={0.48} stopColor={"#dfd1d1"} stopOpacity={0.252} />
            <stop offset={0.86} stopColor={"#f6c0a8"} stopOpacity={0.214} />
            <stop offset={1} stopColor={"#ffb997"} stopOpacity={0.2} />
          </radialGradient>
          <path
            id="Background_1_"
        ...
        <g id="Aries">
          ...
          <text id="XMLID_79_" x={190.125 + xOffset} y={530.52 + yOffset} className="st5 st6">
            {/* {data[1]?.moonPos && `Mo(${data[1]?.moonPos})`} */}
          </text>
          <DetailMapper signNumber={1} x={350} y={230.0} detail={data[1]} />
        ...
        <g id="Taurus">
          ...
          <DetailMapper signNumber={2} x={415} y={125} detail={data[2]} />
        ...
        <g id="Gemini">
          ...
          <DetailMapper signNumber={3} x={350.556} y={45} detail={data[3]} />
        ...
        <g id="Cancer">
          ...
          <DetailMapper signNumber={4} x={225} y={124} detail={data[4]} />
        ...
        <g id="Leo">
          ...
          <DetailMapper signNumber={5} x={95} y={45} detail={data[5]} />
        ...
        <g id="Virgo">
          ...
          <DetailMapper signNumber={6} x={25} y={125} detail={data[6]} />
        ...
        <g id="Libra">
          ...
          <DetailMapper signNumber={7} x={100} y={230} detail={data[7]} />
        ...
        <g id="Scorpio">
          ...
          <DetailMapper signNumber={8} x={30} y={390} detail={data[8]} />
        ...
        <g id="Sagitarus">
          ...
          <DetailMapper signNumber={9} x={100} y={455} detail={data[9]} />
        ...
        <g id="Capricorn">
          ...
          <DetailMapper signNumber={10} x={215} y={360} detail={data[10]} />
        ...
        <g id="Aquarius">
          ...
          <DetailMapper signNumber={11} x={340} y={460} detail={data[11]} />
        ...
        <g id="Pisces">
          ...
          <DetailMapper signNumber={12} x={410} y={395} detail={data[12]} />
...
const Boxes = () => {
  ...
  return (
    <g
      ...
      strokeWidth="1"
    >
      <path id="XMLID_2_" d="M-8 508.5L508 -8" />
      <path id="XMLID_6_" d="M513.5 515L-20.5 -20" />
      <path id="XMLID_8_" d="M499.5 252L236.5 -10" />
      <path id="XMLID_9_" d="M263.5 511L-16.5 238" />
      {/* <path id='XMLID_7_' d='M371.5 511L371.5 -10' /> */}
      <path id="XMLID_4_" d="M0 252.5L248-0.5" />
