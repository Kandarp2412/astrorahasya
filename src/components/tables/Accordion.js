...
function Demo() {
  ...
  const [mahaDashaName, setMahaDashaName] = useState("");
  const [mahaDashaFlag, setMahaDashaFlag] = useState(false);
  ...
  const handleLevel1Dasha = (e, index) => {
    setFlag(!flag);
    setMahaDashaName(e.target.textContent);
    setMahaDashaFlag(!mahaDashaFlag);
                  ...
                  <Accordion>
                    ...
                    <AccordionDetails>
                      <Typography>
                        ...
                        {/* {mahaDashaFlag ? 
                        {subDashaL1 && subDashaL1.length>0? subDashaL1.map((subl1,index)=>{
                          return(<>
                            {mahaDashaName}
                          <AccordionSummary
                                        expandIcon={<ExpandMoreIcon />}
